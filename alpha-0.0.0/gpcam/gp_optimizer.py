...
class GPOptimizer(GP):
    ...
    def train_gp(self,
                 hyperparameter_bounds,
                 method="global",local_optimizer="L-BFGS-B",
                 pop_size=20,
                 tolerance=1e-6,
                 max_iter=120,
                 constraints = (),
        ...
        self.train(
            hyperparameter_bounds,
            init_hyperparameters=self.hyperparameters,
            method=method,local_optimizer=local_optimizer,
            pop_size=pop_size,
            tolerance=tolerance,
            max_iter=max_iter,
            constraints = constraints,
    ...
    def ask(self, position=None, n=1,
            ...
            bounds=None,
            acq_func_opt_local_method="L-BFGS-B",method="global",
            pop_size=20,
            max_iter=20,
            tol=1e-6,
            constraints = (),
        ...
        maxima, func_evals, opt_obj = sm.find_acquisition_function_maxima(
            ...
            position, n, bounds,
            acq_func_opt_local_method=acq_func_opt_local_method,optimization_method=method,
